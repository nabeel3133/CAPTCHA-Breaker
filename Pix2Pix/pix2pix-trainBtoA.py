...
parser.add_argument("--input_dir", default="Pix2Pix\\ganLimitation\\train", help="path to folder containing images")
parser.add_argument("--mode", required=False, default="train", choices=["train", "test", "export"])
parser.add_argument("--output_dir", required=False, default="Pix2Pix\\ganLimitation_trainBtoA", help="where to put output files")
