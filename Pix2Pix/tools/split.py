...
parser.add_argument("--dir", type=str, required=False, default="Pix2Pix\\photos\\combined", help="path to folder containing images")
parser.add_argument("--train_frac", type=float, default=0.7, help="percentage of images to use for training set")
