...
parser.add_argument("--input_dir", required=False, default="Pix2Pix\\photos\\resized1", help="path to folder containing images")
parser.add_argument("--output_dir", required=False, default="Pix2Pix\\photos\\combined", help="output_dir")
parser.add_argument("--operation", required=False, default="combine", choices=["grayscale", "resize", "blank", "combine", "edges"])
parser.add_argument("--workers", type=int, default=1, help="number of workers")
# resize
parser.add_argument("--pad", action="store_true", help="pad instead of crop for resize operation")
parser.add_argument("--size", type=int, default=256, help="size to use for resize operation")
# combine
parser.add_argument("--b_dir", type=str, default="Pix2Pix\\photos\\resized2", help="path to folder containing B images for combine operation")
a = parser.parse_args()
